...
d=conn.execute('''select content,aid,name,category from articles where aid=?''',(name,))
data1=d.fetchall()
l=len(data1)
if(l==1):
...
<body style="background-image:url(/888.jpg)">
	...
	<div class="head-but">
		<a href="adminselectedarticles.py" class="button1">back</a> </div><br>
		<!--//header-->
		<!--main-->
		...
		<div class="main-content-agiless">
			...
			<h2>Title</h2><br>
			 <input type="text" value="''',data1[0][2],'''" /><br><br>
			<h2>Category</h2><br>
			<input type="text" value="''',data1[0][3],'''" /><br><br>
			<h2>Content</h2><br>
