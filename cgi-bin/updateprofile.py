...
body  {
	...
	<div class="main-container">
		...
		<div class="main-content-agile">
			...
			<div class="sub-main-w3xx">	
				<form action="updatefirstpage.py" method="post">
					<input type="text" value="''',data[0][0],'''" required="" name="name">
				
					<input  type="text" value="''',data[0][1],'''" required="" name="dob">
			
                                        <input  type="text" value="''',data[0][2],'''" required="" name="email">
				
				
					<input  type="text" value="''',data[0][3],'''" required="" name="phno">
                    
                                        <input type="text" value="''',data[0][4],'''" required="" name="uname">   
					<input type="password" value="''',data[0][5],'''" required="" name="pwd">
